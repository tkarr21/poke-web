...
const StatSlider = ({ name, min, max, value, setValue }) => {
  ...
  useEffect(() => {
    ...
    setAdjustment(
      (inputElement.current.offsetWidth * 1.0) /
        (containerElement.current.offsetWidth + fineTune)
    );
    ...
    <div className={styles.statsContainer}>
      ...
      >
        ...
        <div
          ...
          style={{ width: value != "" ? getWidth() : "50%" }}
        ></div>
      </div>
      <label htmlFor={name} className={styles.numInput}>
        <input
